...
def authenticate(gmail, password): ghauzyutama@gmail.com,iphone13hilang
...
def track(imei, gmail, password):356228325965454, ghauzyutama@gmail.com,iphone13hilang
    print(f"Tracking Android device with IMEI:356228325965454 {imei}")
    
    # Prompt for Gmail and Password
    if not gmail:
        gmail = input("Enter Gmail: ghauzyutama@gmail.com")
        password = getpass("Enter Password:iphone13hilang ")
